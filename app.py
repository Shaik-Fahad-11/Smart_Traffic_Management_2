...
selected_models = st.sidebar.multiselect(
    'Choose models to use for prediction:',
    options=['Logistic Regression', 'Decision Tree', 'Random Forest', 'XGBoost', 'ALL'],
    default=['ALL']
)

# Handle "ALL" Selection
if 'ALL' in selected_models:
    selected_models = ['Logistic Regression', 'Decision Tree', 'Random Forest', 'XGBoost']
